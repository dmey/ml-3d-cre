...
def main(input_srcfile, reference_output_srcfile, output_srcfile, output2_srcfile, dstdir):
    """
    ...
    if output2_srcfile:
        eplt.compare_output2(input_srcfile, reference_output_srcfile, output_srcfile, output2_srcfile, dstfile=dstfile)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output2", help="ecRAD second output file")
    parser.add_argument("--dstdir", help="Destination directory for plots", default="./")
    args = parser.parse_args()
    
    main(args.input, args.reference, args.output, args.output2, args.dstdir)
